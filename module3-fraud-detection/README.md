...
├── models/                             # gitignored — all three regenerated by the notebooks below
...
### Generate the model
None of the files in `models/` are committed to git — they're build artifacts, all reproducible from the notebooks below. Before running the API, generate them in order:
